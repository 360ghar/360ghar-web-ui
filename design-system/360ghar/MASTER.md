...
|------|-----|--------------|
| Primary | `#ff6b00` | `--color-primary` |
| Secondary | `#ff8c3a` | `--color-secondary` |
| CTA/Accent | `#0369A1` | `--color-cta` |
| Background | `#fff5eb` | `--color-background` |
| Text | `#cc5500` | `--color-text` |

**Color Notes:** Brand orange + professional blue
